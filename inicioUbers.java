...
// !☕ JAVA
    public static void main(String[] args) {
        System.setProperty("prism.order", "sw"); // Força renderização via Software (ajuda com GIFs)
        ...
        ImageIcon wallIcon = new ImageIcon("_UBERS/assets/wallpaper/uberswall.png");
        ...
        // --- 2. O NAVEGADOR (JFXPanel) (☕JAVA por @Shadow_Voidh) ---
        ...
        Platform.runLater(() -> {
            ...
            webView.getEngine().load("http://localhost/_UBERS/Code/Html/inicio.html");
        });

        // --- 3. BARRA ELITE (☕JAVA por @Shadow_Voidh) ---
        ...
        // --- 4. BOTÃO UBER (☕JAVA por @Shadow_Voidh) ---
        JButton btnUber = new JButton();
        ImageIcon icon = new ImageIcon("_UBERS/assets/img/imgUbers/uber.png");
        ...
        // --- 5. LOGO "systemWindows"  (☕JAVA por @Shadow_Voidh)---
        JButton btnEsquerda = new JButton();
        ImageIcon iconU = new ImageIcon("_UBERS/assets/img/imgUbers/ubericon.jpg");
        ...
        // --- 6. BOTÃO VOLTAR  (☕JAVA por @Shadow_Voidh) ---
        JButton btnVoltar = new JButton();
        ImageIcon iconMenu = new ImageIcon("_UBERS/assets/img/imgUbers/menu-burger.png");
